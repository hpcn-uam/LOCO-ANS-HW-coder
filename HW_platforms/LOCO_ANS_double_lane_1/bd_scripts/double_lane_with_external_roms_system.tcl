...
HPCN:loco_ans:TSG_coder_ext_ROM:1.0\
xilinx.com:hls:Y_ANS_ROM:1.0\
xilinx.com:hls:Z_ANS_ROM:1.0\
...
proc create_hier_cell_LOCO_ANS_Encoder { parentCell nameHier } {
  ...
  # Create instance: TSG_coder_ext_ROM_0, and set properties
  set TSG_coder_ext_ROM_0 [ create_bd_cell -type ip -vlnv HPCN:loco_ans:TSG_coder_ext_ROM:1.0 TSG_coder_ext_ROM_0 ]

  # Create instance: TSG_coder_ext_ROM_1, and set properties
  set TSG_coder_ext_ROM_1 [ create_bd_cell -type ip -vlnv HPCN:loco_ans:TSG_coder_ext_ROM:1.0 TSG_coder_ext_ROM_1 ]

  # Create instance: Y_ANS_ROM_0, and set properties
  set Y_ANS_ROM_0 [ create_bd_cell -type ip -vlnv xilinx.com:hls:Y_ANS_ROM:1.0 Y_ANS_ROM_0 ]

  # Create instance: Z_ANS_ROM_0, and set properties
  set Z_ANS_ROM_0 [ create_bd_cell -type ip -vlnv xilinx.com:hls:Z_ANS_ROM:1.0 Z_ANS_ROM_0 ]
  ...
  connect_bd_intf_net -intf_net St_idx_compute_0_out_symbols_V [get_bd_intf_pins St_idx_compute_0/out_symbols_V] [get_bd_intf_pins TSG_coder_ext_ROM_0/in_V]
  connect_bd_intf_net -intf_net [get_bd_intf_nets St_idx_compute_0_out_symbols_V] [get_bd_intf_pins TSG_coder_ext_ROM_0/in_V] [get_bd_intf_pins system_ila_0/SLOT_4_AXIS]
  connect_bd_intf_net -intf_net St_idx_compute_1_out_symbols_V [get_bd_intf_pins St_idx_compute_1/out_symbols_V] [get_bd_intf_pins TSG_coder_ext_ROM_1/in_V]
  connect_bd_intf_net -intf_net TSG_coder_0_byte_block_stream [get_bd_intf_pins File_writer_0/in_byte_block_stream] [get_bd_intf_pins TSG_coder_ext_ROM_0/byte_block_stream]
  connect_bd_intf_net -intf_net [get_bd_intf_nets TSG_coder_0_byte_block_stream] [get_bd_intf_pins TSG_coder_ext_ROM_0/byte_block_stream] [get_bd_intf_pins system_ila_0/SLOT_5_AXIS]
  connect_bd_intf_net -intf_net TSG_coder_ext_ROM_0_out_blk_metadata_V [get_bd_intf_pins File_writer_0/in_blk_metadata_V] [get_bd_intf_pins TSG_coder_ext_ROM_0/out_blk_metadata_V]
  connect_bd_intf_net -intf_net TSG_coder_ext_ROM_1_byte_block_stream [get_bd_intf_pins File_writer_1/in_byte_block_stream] [get_bd_intf_pins TSG_coder_ext_ROM_1/byte_block_stream]
  connect_bd_intf_net -intf_net [get_bd_intf_nets TSG_coder_ext_ROM_1_byte_block_stream] [get_bd_intf_pins TSG_coder_ext_ROM_1/byte_block_stream] [get_bd_intf_pins system_ila_0/SLOT_3_AXIS]
  connect_bd_intf_net -intf_net TSG_coder_ext_ROM_1_out_blk_metadata_V [get_bd_intf_pins File_writer_1/in_blk_metadata_V] [get_bd_intf_pins TSG_coder_ext_ROM_1/out_blk_metadata_V]
  ...
  connect_bd_net -net TSG_coder_ext_ROM_0_tANS_y_encode_table_address0 [get_bd_pins TSG_coder_ext_ROM_0/tANS_y_encode_table_address0] [get_bd_pins Y_ANS_ROM_0/address_A]
  connect_bd_net -net TSG_coder_ext_ROM_0_tANS_z_encode_table_address0 [get_bd_pins TSG_coder_ext_ROM_0/tANS_z_encode_table_address0] [get_bd_pins Z_ANS_ROM_0/address_A]
  connect_bd_net -net TSG_coder_ext_ROM_1_tANS_y_encode_table_address0 [get_bd_pins TSG_coder_ext_ROM_1/tANS_y_encode_table_address0] [get_bd_pins Y_ANS_ROM_0/address_B]
  connect_bd_net -net TSG_coder_ext_ROM_1_tANS_z_encode_table_address0 [get_bd_pins TSG_coder_ext_ROM_1/tANS_z_encode_table_address0] [get_bd_pins Z_ANS_ROM_0/address_B]
  connect_bd_net -net Y_ANS_ROM_0_d_out_A [get_bd_pins TSG_coder_ext_ROM_0/tANS_y_encode_table_q0] [get_bd_pins Y_ANS_ROM_0/d_out_A]
  connect_bd_net -net Y_ANS_ROM_0_d_out_B [get_bd_pins TSG_coder_ext_ROM_1/tANS_y_encode_table_q0] [get_bd_pins Y_ANS_ROM_0/d_out_B]
  connect_bd_net -net Z_ANS_ROM_0_d_out_A [get_bd_pins TSG_coder_ext_ROM_0/tANS_z_encode_table_q0] [get_bd_pins Z_ANS_ROM_0/d_out_A]
  connect_bd_net -net Z_ANS_ROM_0_d_out_B [get_bd_pins TSG_coder_ext_ROM_1/tANS_z_encode_table_q0] [get_bd_pins Z_ANS_ROM_0/d_out_B]
  connect_bd_net -net c_counter_binary_0_Q [get_bd_pins c_counter_binary_0/Q] [get_bd_pins system_ila_0/probe0]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins ap_clk] [get_bd_pins File_writer_0/ap_clk] [get_bd_pins File_writer_1/ap_clk] [get_bd_pins LOCO_decorrelator_0/ap_clk] [get_bd_pins LOCO_decorrelator_1/ap_clk] [get_bd_pins St_idx_compute_0/ap_clk] [get_bd_pins St_idx_compute_1/ap_clk] [get_bd_pins TSG_coder_ext_ROM_0/ap_clk] [get_bd_pins TSG_coder_ext_ROM_1/ap_clk] [get_bd_pins Y_ANS_ROM_0/ap_clk] [get_bd_pins Z_ANS_ROM_0/ap_clk] [get_bd_pins c_counter_binary_0/CLK] [get_bd_pins odma_0/ap_clk] [get_bd_pins odma_1/ap_clk] [get_bd_pins system_ila_0/clk]
  connect_bd_net -net rst_ps7_0_50M_peripheral_aresetn [get_bd_pins ap_rst_n] [get_bd_pins File_writer_0/ap_rst_n] [get_bd_pins File_writer_1/ap_rst_n] [get_bd_pins LOCO_decorrelator_0/ap_rst_n] [get_bd_pins LOCO_decorrelator_1/ap_rst_n] [get_bd_pins St_idx_compute_0/ap_rst_n] [get_bd_pins St_idx_compute_1/ap_rst_n] [get_bd_pins TSG_coder_ext_ROM_0/ap_rst_n] [get_bd_pins TSG_coder_ext_ROM_1/ap_rst_n] [get_bd_pins Y_ANS_ROM_0/ap_rst_n] [get_bd_pins Z_ANS_ROM_0/ap_rst_n] [get_bd_pins odma_0/ap_rst_n] [get_bd_pins odma_1/ap_rst_n] [get_bd_pins system_ila_0/resetn]
