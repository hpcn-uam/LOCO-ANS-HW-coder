...
proc create_hier_cell_LOCO_ANS_Encoder { parentCell nameHier } {
  ...
  connect_bd_intf_net -intf_net [get_bd_intf_nets File_writer_1_out_command_V] [get_bd_intf_pins odma_1/in_command_V] [get_bd_intf_pins system_ila_0/SLOT_3_AXIS]
  ...
  connect_bd_intf_net -intf_net [get_bd_intf_nets TSG_coder_double_lane_0_byte_block_stream_1] [get_bd_intf_pins TSG_coder_double_lane_0/byte_block_stream_1] [get_bd_intf_pins system_ila_0/SLOT_1_AXIS]
  ...
  connect_bd_intf_net -intf_net [get_bd_intf_nets TSG_coder_double_lane_0_out_blk_metadata_1_V] [get_bd_intf_pins File_writer_1/in_blk_metadata_V] [get_bd_intf_pins system_ila_0/SLOT_2_AXIS]
  ...
  connect_bd_net -net resetn_1 [get_bd_pins rst_1_n] [get_bd_pins File_writer_0/ap_rst_n] [get_bd_pins File_writer_1/ap_rst_n] [get_bd_pins TSG_coder_double_lane_0/ap_rst_n] [get_bd_pins odma_0/ap_rst_n] [get_bd_pins odma_1/ap_rst_n] [get_bd_pins system_ila_0/resetn]
...
0#Enet 0}\
  ...
  # Create port connections
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins LOCO_ANS_Encoder/ap_clk0] [get_bd_pins axi_mem_intercon/S00_ACLK] [get_bd_pins axi_mem_intercon/S02_ACLK] [get_bd_pins idma_0/ap_clk] [get_bd_pins idma_1/ap_clk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/M02_ACLK] [get_bd_pins ps7_0_axi_periph/M03_ACLK] [get_bd_pins ps7_0_axi_periph/M04_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins rst_ps7_0_50M/slowest_sync_clk]
  connect_bd_net -net processing_system7_0_FCLK_CLK1 [get_bd_pins LOCO_ANS_Encoder/ap_clk1] [get_bd_pins axi_mem_intercon/ACLK] [get_bd_pins axi_mem_intercon/M00_ACLK] [get_bd_pins axi_mem_intercon/S01_ACLK] [get_bd_pins axi_mem_intercon/S03_ACLK] [get_bd_pins processing_system7_0/FCLK_CLK1] [get_bd_pins processing_system7_0/S_AXI_ACP_ACLK] [get_bd_pins ps7_0_axi_periph/M01_ACLK] [get_bd_pins ps7_0_axi_periph/M05_ACLK] [get_bd_pins rst_ps7_0_142M/slowest_sync_clk]
  ...
  assign_bd_address -offset 0x40040000 -range 0x00010000 -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs LOCO_ANS_Encoder/LOCO_decorrelator_LS_1/s_axi_config/Reg] -force
