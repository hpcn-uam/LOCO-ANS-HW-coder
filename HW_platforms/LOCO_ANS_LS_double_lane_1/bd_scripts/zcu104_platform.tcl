...
if { $bCheckIPs == 1 } {
   set list_check_ips "\
HPCN:loco_ans:idma:1.1\
xilinx.com:ip:proc_sys_reset:5.0\
xilinx.com:ip:zynq_ultra_ps_e:3.3\
HPCN:loco_ans:File_writer:1.1\
HPCN:loco_ans:LOCO_decorrelator_LS:1.1\
HPCN:loco_ans:St_idx_compute:1.1\
HPCN:loco_ans:TSG_coder_double_lane:1.1\
xilinx.com:ip:axis_data_fifo:2.0\
HPCN:loco_ans:odma:1.1\
"
...
proc create_hier_cell_LOCO_ANS_Encoder { parentCell nameHier } {
  ...
  # Create pins
  create_bd_pin -dir I -type clk ap_clk_decorrelator
  create_bd_pin -dir I -type clk ap_clk_odma
  create_bd_pin -dir I -type rst ap_rst_n
  create_bd_pin -dir I -type clk clk_tsg_coder
  create_bd_pin -dir I -type rst rst_0_n
  create_bd_pin -dir I -type rst rst_1_n

  # Create instance: File_writer_0, and set properties
  set File_writer_0 [ create_bd_cell -type ip -vlnv HPCN:loco_ans:File_writer:1.1 File_writer_0 ]

  # Create instance: File_writer_1, and set properties
  set File_writer_1 [ create_bd_cell -type ip -vlnv HPCN:loco_ans:File_writer:1.1 File_writer_1 ]

  # Create instance: LOCO_decorrelator_LS_0, and set properties
  set LOCO_decorrelator_LS_0 [ create_bd_cell -type ip -vlnv HPCN:loco_ans:LOCO_decorrelator_LS:1.1 LOCO_decorrelator_LS_0 ]

  # Create instance: LOCO_decorrelator_LS_1, and set properties
  set LOCO_decorrelator_LS_1 [ create_bd_cell -type ip -vlnv HPCN:loco_ans:LOCO_decorrelator_LS:1.1 LOCO_decorrelator_LS_1 ]

  # Create instance: St_idx_compute_0, and set properties
  set St_idx_compute_0 [ create_bd_cell -type ip -vlnv HPCN:loco_ans:St_idx_compute:1.1 St_idx_compute_0 ]
  ...
  set odma_0 [ create_bd_cell -type ip -vlnv HPCN:loco_ans:odma:1.1 odma_0 ]

  # Create instance: odma_1, and set properties
  set odma_1 [ create_bd_cell -type ip -vlnv HPCN:loco_ans:odma:1.1 odma_1 ]
  ...
  # Create instance: symbol_fifo2, and set properties
  set symbol_fifo2 [ create_bd_cell -type ip -vlnv xilinx.com:ip:axis_data_fifo:2.0 symbol_fifo2 ]
  set_property -dict [ list \
   CONFIG.IS_ACLK_ASYNC {1} \
 ] $symbol_fifo2

  # Create instance: symbol_fifo3, and set properties
  set symbol_fifo3 [ create_bd_cell -type ip -vlnv xilinx.com:ip:axis_data_fifo:2.0 symbol_fifo3 ]
  set_property -dict [ list \
   CONFIG.IS_ACLK_ASYNC {1} \
 ] $symbol_fifo3

  # Create instance: symbol_fifo4, and set properties
  set symbol_fifo4 [ create_bd_cell -type ip -vlnv xilinx.com:ip:axis_data_fifo:2.0 symbol_fifo4 ]
  set_property -dict [ list \
   CONFIG.IS_ACLK_ASYNC {1} \
 ] $symbol_fifo4

  # Create instance: symbol_fifo5, and set properties
  set symbol_fifo5 [ create_bd_cell -type ip -vlnv xilinx.com:ip:axis_data_fifo:2.0 symbol_fifo5 ]
  set_property -dict [ list \
   CONFIG.IS_ACLK_ASYNC {1} \
 ] $symbol_fifo5
  ...
  connect_bd_intf_net -intf_net LOCO_decorrelator_LS_0_first_px_out_V [get_bd_intf_pins LOCO_decorrelator_LS_0/first_px_out_V] [get_bd_intf_pins first_px_fifo/S_AXIS]
  connect_bd_intf_net -intf_net LOCO_decorrelator_LS_0_symbols_V [get_bd_intf_pins LOCO_decorrelator_LS_0/symbols_V] [get_bd_intf_pins St_idx_compute_0/in_symbols_V]
  ...
  connect_bd_intf_net -intf_net odma_2_m_axi_mem1 [get_bd_intf_pins m_axi_mem1] [get_bd_intf_pins odma_1/m_axi_mem]
  connect_bd_intf_net -intf_net s_axi_config_1 [get_bd_intf_pins s_axi_config] [get_bd_intf_pins LOCO_decorrelator_LS_1/s_axi_config]
...
proc create_root_design { parentCell } {
  ...
  # Create instance: axi_mem_idma0, and set properties
  set axi_mem_idma0 [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_interconnect:2.1 axi_mem_idma0 ]
  set_property -dict [ list \
  ...
  # Create instance: axi_mem_idma1, and set properties
  set axi_mem_idma1 [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_interconnect:2.1 axi_mem_idma1 ]
  set_property -dict [ list \
   CONFIG.ENABLE_ADVANCED_OPTIONS {1} \
   CONFIG.M00_HAS_REGSLICE {0} \
   CONFIG.NUM_MI {1} \
  ...
  # Create instance: axi_mem_odma0, and set properties
  set axi_mem_odma0 [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_interconnect:2.1 axi_mem_odma0 ]
  set_property -dict [ list \
   CONFIG.ENABLE_ADVANCED_OPTIONS {1} \
   CONFIG.M00_HAS_REGSLICE {0} \
   CONFIG.NUM_MI {1} \
  ...
  # Create instance: axi_mem_odma1, and set properties
  set axi_mem_odma1 [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_interconnect:2.1 axi_mem_odma1 ]
  set_property -dict [ list \
   CONFIG.ENABLE_ADVANCED_OPTIONS {1} \
   CONFIG.M00_HAS_REGSLICE {0} \
   CONFIG.NUM_MI {1} \
  ...
  set idma_0 [ create_bd_cell -type ip -vlnv HPCN:loco_ans:idma:1.1 idma_0 ]

  # Create instance: idma_1, and set properties
  set idma_1 [ create_bd_cell -type ip -vlnv HPCN:loco_ans:idma:1.1 idma_1 ]
  ...
  # Create instance: rst_ps7_1, and set properties
  set rst_ps7_1 [ create_bd_cell -type ip -vlnv xilinx.com:ip:proc_sys_reset:5.0 rst_ps7_1 ]

  # Create instance: rst_ps7_2, and set properties
  set rst_ps7_2 [ create_bd_cell -type ip -vlnv xilinx.com:ip:proc_sys_reset:5.0 rst_ps7_2 ]
...
Port;FD4A0000;FD4AFFFF;1|FPD;DPDMA;FD4C0000;FD4CFFFF;1|FPD;DDR_XMPU5_CFG;FD050000;FD05FFFF;1|FPD;DDR_XMPU4_CFG;FD040000;FD04FFFF;1|FPD;DDR_XMPU3_CFG;FD030000;FD03FFFF;1|FPD;DDR_XMPU2_CFG;FD020000;FD02FFFF;1|FPD;DDR_XMPU1_CFG;FD010000;FD01FFFF;1|FPD;DDR_XMPU0_CFG;FD000000;FD00FFFF;1|FPD;DDR_QOS_CTRL;FD090000;FD09FFFF;1|FPD;DDR_PHY;FD080000;FD08FFFF;1|DDR;DDR_LOW;0;7FFFFFFF;1|DDR;DDR_HIGH;800000000;800000000;0|FPD;DDDR_CTRL;FD070000;FD070FFF;1|LPD;Coresight;FE800000;FEFFFFFF;1|LPD;CSU_DMA;FFC80000;FFC9FFFF;1|LPD;CSU;FFCA0000;FFCAFFFF;1|LPD;CRL_APB;FF5E0000;FF85FFFF;1|FPD;CRF_APB;FD1A0000;FD2DFFFF;1|FPD;CCI_REG;FD5E0000;FD5EFFFF;1|LPD;CAN1;FF070000;FF07FFFF;1|LPD;CAN0;FF060000;FF06FFFF;0|FPD;APU;FD5C0000;FD5CFFFF;1|LPD;APM_INTC_IOU;FFA20000;FFA2FFFF;1|LPD;APM_FPD_LPD;FFA30000;FFA3FFFF;1|FPD;APM_5;FD490000;FD49FFFF;1|FPD;APM_0;FD0B0000;FD0BFFFF;1|LPD;APM2;FFA10000;FFA1FFFF;1|LPD;APM1;FFA00000;FFA0FFFF;1|LPD;AMS;FFA50000;FFA5FFFF;1|FPD;AFI_5;FD3B0000;FD3BFFFF;1|FPD;AFI_4;FD3A0000;FD3AFFFF;1|FPD;AFI_3;FD390000;FD39FFFF;1|FPD;AFI_2;FD380000;FD38FFFF;1|FPD;AFI_1;FD370000;FD37FFFF;1|FPD;AFI_0;FD360000;FD36FFFF;1|LPD;AFIFM6;FF9B0000;FF9BFFFF;1|FPD;ACPU_GIC;F9010000;F907FFFF;1}\
  ...
  # Create interface connections
  connect_bd_intf_net -intf_net LOCO_ANS_Encoder_m_axi_mem [get_bd_intf_pins LOCO_ANS_Encoder/m_axi_mem] [get_bd_intf_pins axi_mem_odma0/S00_AXI]
  connect_bd_intf_net -intf_net LOCO_ANS_Encoder_m_axi_mem1 [get_bd_intf_pins LOCO_ANS_Encoder/m_axi_mem1] [get_bd_intf_pins axi_mem_odma1/S00_AXI]
  connect_bd_intf_net -intf_net S00_AXI_1 [get_bd_intf_pins axi_mem_idma0/S00_AXI] [get_bd_intf_pins idma_0/m_axi_mem]
  connect_bd_intf_net -intf_net S00_AXI_2 [get_bd_intf_pins axi_mem_idma1/S00_AXI] [get_bd_intf_pins idma_1/m_axi_mem]
  connect_bd_intf_net -intf_net axi_mem_idma1_M00_AXI [get_bd_intf_pins axi_mem_idma1/M00_AXI] [get_bd_intf_pins zynq_ultra_ps_e_0/S_AXI_HP1_FPD]
  connect_bd_intf_net -intf_net axi_mem_intercon_M00_AXI [get_bd_intf_pins axi_mem_idma0/M00_AXI] [get_bd_intf_pins zynq_ultra_ps_e_0/S_AXI_HP0_FPD]
  connect_bd_intf_net -intf_net axi_mem_odma0_M00_AXI [get_bd_intf_pins axi_mem_odma0/M00_AXI] [get_bd_intf_pins zynq_ultra_ps_e_0/S_AXI_HP2_FPD]
  connect_bd_intf_net -intf_net axi_mem_odma1_M00_AXI [get_bd_intf_pins axi_mem_odma1/M00_AXI] [get_bd_intf_pins zynq_ultra_ps_e_0/S_AXI_HP3_FPD]
  connect_bd_intf_net -intf_net idma_2_out_stream_V [get_bd_intf_pins LOCO_ANS_Encoder/src_V1] [get_bd_intf_pins idma_1/out_stream_V]
  ...
  connect_bd_intf_net -intf_net src_V_1 [get_bd_intf_pins LOCO_ANS_Encoder/src_V] [get_bd_intf_pins idma_0/out_stream_V]
  ...
  # Create port connections
  connect_bd_net -net processing_system7_0_FCLK_CLK1 [get_bd_pins LOCO_ANS_Encoder/ap_clk_decorrelator] [get_bd_pins axi_mem_idma0/ACLK] [get_bd_pins axi_mem_idma0/M00_ACLK] [get_bd_pins axi_mem_idma0/S00_ACLK] [get_bd_pins axi_mem_idma1/ACLK] [get_bd_pins axi_mem_idma1/M00_ACLK] [get_bd_pins axi_mem_idma1/S00_ACLK] [get_bd_pins idma_0/ap_clk] [get_bd_pins idma_1/ap_clk] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/M02_ACLK] [get_bd_pins ps7_0_axi_periph/M03_ACLK] [get_bd_pins ps7_0_axi_periph/M04_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins rst_ps7_0/slowest_sync_clk] [get_bd_pins zynq_ultra_ps_e_0/maxihpm0_fpd_aclk] [get_bd_pins zynq_ultra_ps_e_0/pl_clk0] [get_bd_pins zynq_ultra_ps_e_0/saxihp0_fpd_aclk] [get_bd_pins zynq_ultra_ps_e_0/saxihp1_fpd_aclk]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins rst_ps7_0/ext_reset_in] [get_bd_pins rst_ps7_1/ext_reset_in] [get_bd_pins rst_ps7_2/ext_reset_in] [get_bd_pins zynq_ultra_ps_e_0/pl_resetn0]
  connect_bd_net -net rst_ps7_0_142M_peripheral_aresetn [get_bd_pins LOCO_ANS_Encoder/rst_1_n] [get_bd_pins axi_mem_odma0/ARESETN] [get_bd_pins axi_mem_odma0/M00_ARESETN] [get_bd_pins axi_mem_odma0/S00_ARESETN] [get_bd_pins axi_mem_odma1/ARESETN] [get_bd_pins axi_mem_odma1/M00_ARESETN] [get_bd_pins axi_mem_odma1/S00_ARESETN] [get_bd_pins ps7_0_axi_periph/M01_ARESETN] [get_bd_pins ps7_0_axi_periph/M05_ARESETN] [get_bd_pins rst_ps7_1/peripheral_aresetn]
  connect_bd_net -net rst_ps7_0_50M_peripheral_aresetn [get_bd_pins LOCO_ANS_Encoder/rst_0_n] [get_bd_pins axi_mem_idma0/ARESETN] [get_bd_pins axi_mem_idma0/M00_ARESETN] [get_bd_pins axi_mem_idma0/S00_ARESETN] [get_bd_pins axi_mem_idma1/ARESETN] [get_bd_pins axi_mem_idma1/M00_ARESETN] [get_bd_pins axi_mem_idma1/S00_ARESETN] [get_bd_pins idma_0/ap_rst_n] [get_bd_pins idma_1/ap_rst_n] [get_bd_pins ps7_0_axi_periph/ARESETN] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/M02_ARESETN] [get_bd_pins ps7_0_axi_periph/M03_ARESETN] [get_bd_pins ps7_0_axi_periph/M04_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps7_0/peripheral_aresetn]
  connect_bd_net -net rst_ps7_2_peripheral_aresetn [get_bd_pins LOCO_ANS_Encoder/ap_rst_n] [get_bd_pins rst_ps7_2/peripheral_aresetn]
  connect_bd_net -net zynq_ultra_ps_e_0_pl_clk1 [get_bd_pins LOCO_ANS_Encoder/ap_clk_odma] [get_bd_pins axi_mem_odma0/ACLK] [get_bd_pins axi_mem_odma0/M00_ACLK] [get_bd_pins axi_mem_odma0/S00_ACLK] [get_bd_pins axi_mem_odma1/ACLK] [get_bd_pins axi_mem_odma1/M00_ACLK] [get_bd_pins axi_mem_odma1/S00_ACLK] [get_bd_pins ps7_0_axi_periph/M01_ACLK] [get_bd_pins ps7_0_axi_periph/M05_ACLK] [get_bd_pins rst_ps7_1/slowest_sync_clk] [get_bd_pins zynq_ultra_ps_e_0/pl_clk1] [get_bd_pins zynq_ultra_ps_e_0/saxihp2_fpd_aclk] [get_bd_pins zynq_ultra_ps_e_0/saxihp3_fpd_aclk]
  connect_bd_net -net zynq_ultra_ps_e_0_pl_clk2 [get_bd_pins LOCO_ANS_Encoder/clk_tsg_coder] [get_bd_pins rst_ps7_2/slowest_sync_clk] [get_bd_pins zynq_ultra_ps_e_0/pl_clk2]

  # Create address segments
  assign_bd_address -offset 0x00000000 -range 0x80000000 -target_address_space [get_bd_addr_spaces idma_0/Data_m_axi_mem] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP2/HP0_DDR_LOW] -force
  assign_bd_address -offset 0xC0000000 -range 0x20000000 -target_address_space [get_bd_addr_spaces idma_0/Data_m_axi_mem] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP2/HP0_QSPI] -force
  assign_bd_address -offset 0x00000000 -range 0x80000000 -target_address_space [get_bd_addr_spaces idma_1/Data_m_axi_mem] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP3/HP1_DDR_LOW] -force
  assign_bd_address -offset 0xC0000000 -range 0x20000000 -target_address_space [get_bd_addr_spaces idma_1/Data_m_axi_mem] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP3/HP1_QSPI] -force
  assign_bd_address -offset 0xA0000000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs LOCO_ANS_Encoder/LOCO_decorrelator_LS_0/s_axi_config/Reg] -force
  assign_bd_address -offset 0xA0010000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs LOCO_ANS_Encoder/LOCO_decorrelator_LS_1/s_axi_config/Reg] -force
  assign_bd_address -offset 0xA0040000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs idma_0/s_axi_control/Reg] -force
  assign_bd_address -offset 0xA0050000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs idma_1/s_axi_control/Reg] -force
  assign_bd_address -offset 0xA0020000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs LOCO_ANS_Encoder/odma_0/s_axi_control/Reg] -force
  assign_bd_address -offset 0xA0030000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs LOCO_ANS_Encoder/odma_1/s_axi_control/Reg] -force
  assign_bd_address -offset 0x00000000 -range 0x80000000 -target_address_space [get_bd_addr_spaces LOCO_ANS_Encoder/odma_0/Data_m_axi_mem] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP4/HP2_DDR_LOW] -force
  assign_bd_address -offset 0xC0000000 -range 0x20000000 -target_address_space [get_bd_addr_spaces LOCO_ANS_Encoder/odma_0/Data_m_axi_mem] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP4/HP2_QSPI] -force
  assign_bd_address -offset 0x00000000 -range 0x80000000 -target_address_space [get_bd_addr_spaces LOCO_ANS_Encoder/odma_1/Data_m_axi_mem] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP5/HP3_DDR_LOW] -force
  assign_bd_address -offset 0xC0000000 -range 0x20000000 -target_address_space [get_bd_addr_spaces LOCO_ANS_Encoder/odma_1/Data_m_axi_mem] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP5/HP3_QSPI] -force

  # Exclude Address Segments
  exclude_bd_addr_seg -offset 0xFF000000 -range 0x01000000 -target_address_space [get_bd_addr_spaces LOCO_ANS_Encoder/odma_0/Data_m_axi_mem] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP4/HP2_LPS_OCM]
  exclude_bd_addr_seg -offset 0xFF000000 -range 0x01000000 -target_address_space [get_bd_addr_spaces LOCO_ANS_Encoder/odma_1/Data_m_axi_mem] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP5/HP3_LPS_OCM]
  exclude_bd_addr_seg -offset 0xFF000000 -range 0x01000000 -target_address_space [get_bd_addr_spaces idma_0/Data_m_axi_mem] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP2/HP0_LPS_OCM]
  exclude_bd_addr_seg -offset 0xFF000000 -range 0x01000000 -target_address_space [get_bd_addr_spaces idma_1/Data_m_axi_mem] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP3/HP1_LPS_OCM]
