...
proc create_hier_cell_LOCO_ANS_Encoder { parentCell nameHier } {
  ...
  connect_bd_intf_net -intf_net St_idx_compute_0_out_symbols_V [get_bd_intf_pins St_idx_compute_0/out_symbols_V] [get_bd_intf_pins TSG_coder_0/in_V]
  connect_bd_intf_net -intf_net [get_bd_intf_nets St_idx_compute_0_out_symbols_V] [get_bd_intf_pins TSG_coder_0/in_V] [get_bd_intf_pins system_ila_0/SLOT_4_AXIS]
  ...
  connect_bd_intf_net -intf_net [get_bd_intf_nets TSG_input_adapter_0_out_V] [get_bd_intf_pins src_V] [get_bd_intf_pins system_ila_0/SLOT_1_AXIS]
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M02_AXI [get_bd_intf_pins CODER_control] [get_bd_intf_pins LOCO_decorrelator_0/s_axi_config]

  # Create port connections
  connect_bd_net -net c_counter_binary_0_Q [get_bd_pins c_counter_binary_0/Q] [get_bd_pins system_ila_0/probe0]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins ap_clk] [get_bd_pins File_writer_0/ap_clk] [get_bd_pins LOCO_decorrelator_0/ap_clk] [get_bd_pins St_idx_compute_0/ap_clk] [get_bd_pins TSG_coder_0/ap_clk] [get_bd_pins c_counter_binary_0/CLK] [get_bd_pins odma_0/ap_clk] [get_bd_pins system_ila_0/clk]
  connect_bd_net -net rst_ps7_0_50M_peripheral_aresetn [get_bd_pins ap_rst_n] [get_bd_pins File_writer_0/ap_rst_n] [get_bd_pins LOCO_decorrelator_0/ap_rst_n] [get_bd_pins St_idx_compute_0/ap_rst_n] [get_bd_pins TSG_coder_0/ap_rst_n] [get_bd_pins odma_0/ap_rst_n] [get_bd_pins system_ila_0/resetn]
...
0#Enet 0}\
  ...
  # Create port connections
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins LOCO_ANS_Encoder/ap_clk] [get_bd_pins axi_mem_intercon/ACLK] [get_bd_pins axi_mem_intercon/M00_ACLK] [get_bd_pins axi_mem_intercon/S00_ACLK] [get_bd_pins axi_mem_intercon/S01_ACLK] [get_bd_pins idma_0/ap_clk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins processing_system7_0/S_AXI_ACP_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/M01_ACLK] [get_bd_pins ps7_0_axi_periph/M02_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins rst_ps7_0_50M/slowest_sync_clk]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins rst_ps7_0_50M/ext_reset_in]
  connect_bd_net -net rst_ps7_0_50M_peripheral_aresetn [get_bd_pins LOCO_ANS_Encoder/ap_rst_n] [get_bd_pins axi_mem_intercon/ARESETN] [get_bd_pins axi_mem_intercon/M00_ARESETN] [get_bd_pins axi_mem_intercon/S00_ARESETN] [get_bd_pins axi_mem_intercon/S01_ARESETN] [get_bd_pins idma_0/ap_rst_n] [get_bd_pins ps7_0_axi_periph/ARESETN] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/M01_ARESETN] [get_bd_pins ps7_0_axi_periph/M02_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps7_0_50M/peripheral_aresetn]
