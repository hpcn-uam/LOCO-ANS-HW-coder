...
int main(int argc, char const *argv[])
{
  ...
  for (int blk_idx = 0; blk_idx < NUM_OF_BLCKS; ++blk_idx){
    ...
    TSG_coder(in_data,byte_blocks,last_byte_idx);

    // ************
    // Check output
    // ************
    ASSERT(byte_blocks.empty()==false);
    ASSERT(last_byte_idx.empty()==false);
    ...
    int hw_last_byte_idx_element = last_byte_idx.read();
